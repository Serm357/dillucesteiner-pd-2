// app/components/HomePageComponents/ImageSlider.tsx
"use client";
...
const ImageSlider = ({ posts }: ImageSliderProps) => {
  ...
  const secondBlog = posts[1];

  // Initialize carousel (assuming you're using hs-carousel)
  useEffect(() => {
    if (typeof window !== "undefined") {
      // Add your carousel initialization logic here if needed
      // For example, if using a third-party carousel library
    }
  }, []);
