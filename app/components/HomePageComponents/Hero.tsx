...
export default function Hero() {
  return (
    <section className="w-full h-screen overflow-hidden bg-[url('/vid2.gif')] bg-no-repeat bg-cover bg-center p-4 text-center">
      <div className="flex flex-col md:flex-row gap-2 justify-center items-center">
        ...
        <div className="flex-1 py-2 pb-2 mt-3  bg-transparent border-[1px] border-primary-foreground rounded-md flex flex-col justify-center items-center md:min-w-[400px] ">
          ...
          <p className="text-md text-center text-sm font-bold leading-relaxed py-3">
